        ...
        <div className="about__hello" ref={helloRef}>
          ...
          <div className="about__hello-content">
            <div className="about__hello-text">
              ...
              >
                Hello, I'm{' '}
                <span className="about__greeting-name">Mark</span>.
              </motion.h2>
              <motion.p
                ...
                custom={0.2}
              >
                A passionate designer and developer based in the Philippines. 
                I craft digital experiences that combine clean aesthetics with 
                thoughtful functionality — bringing ideas to life through code 
                and creativity.
              </motion.p>
            </div>
            ...
            >
              <div className="about__photo-wrapper">
                <div className="about__photo-placeholder">
                  <div className="about__photo-placeholder-icon">📷</div>
